(function () {
  ...
  var I18N = {
    es: {
      ...
      "hub.loginHint": "Desde aquí ves todo el sistema: subir autos/motos, 4 fotos, editar cualquier ficha y guardar en catálogo. El cliente solo recibe el link bloqueado.",
      ...
      "hub.logout": "Salir",
      "hub.formTitle": "Nueva ayuda",
      "hub.formHelp": "Autos/motos nuevos crean carpeta sola. Completa datos + 4 fotos y pulsa Guardar en catálogo. Las fotos se comprimen; el catálogo guarda rutas livianas para escalar a muchas ayudas.",
      "hub.foldersTitle": "Carpetas por marca",
      "hub.foldersLead": "Nissan, Yamaha, Toyota… Cada marca es una carpeta. Entra para ver, editar o borrar sus ayudas.",
      "hub.filterAll": "Todas",
      ...
      "ayuda.readonly": "Solo lectura · HELP ONLINE",
      "ayuda.backAdmin": "← Volver al administrador (solo creador)",
      "ayuda.eeprom": "EEPROM",
      "ayuda.programmer": "PROGRAMADOR",
      "ayuda.type": "TIPO",
      "ayuda.notes": "NOTAS",
      "ayuda.onlyUnit": "SOLO ESTA UNIDAD",
      "ayuda.onlyUnitDesc": "Enlace específico",
      "ayuda.readOnly": "SOLO LECTURA",
      "ayuda.readOnlyDesc": "No se puede editar",
      "ayuda.photos": "FOTOS",
      "ayuda.photosDesc": "Usa las flechas",
      "ayuda.support": "SOPORTE",
      "ayuda.supportDesc": "UPA USB",
      "ayuda.gallery": "Galería de ayuda",
      "ayuda.prev": "Anterior",
      "ayuda.next": "Siguiente",
      "ayuda.missing": "Ayuda no encontrada para este enlace.",
      "ayuda.incomplete": "Enlace de ayuda incompleto. Pide al soporte el link específico de tu unidad."
    },
    en: {
      ...
      "hub.loginTitle": "ADMIN HELP ONLINE",
      "hub.loginHint": "From here you manage the whole system: upload cars/bikes, 4 photos, edit any sheet and save to catalog. The client only gets the locked link.",
      ...
      "hub.logout": "Log out",
      "hub.formTitle": "New help",
      "hub.formHelp": "New cars/bikes create their own folder. Fill data + 4 photos and tap Save to catalog. Photos are compressed; the catalog stores light paths so many helps can scale.",
      "hub.foldersTitle": "Folders by brand",
      "hub.foldersLead": "Nissan, Yamaha, Toyota… Each brand is a folder. Open it to view, edit or delete helps.",
      "hub.filterAll": "All",
      "hub.filterCars": "Cars",
      ...
      "ayuda.readonly": "Read only · HELP ONLINE",
      "ayuda.backAdmin": "← Back to administrator (creator only)",
      "ayuda.eeprom": "EEPROM",
      "ayuda.programmer": "PROGRAMMER",
      "ayuda.type": "TYPE",
      "ayuda.notes": "NOTES",
      "ayuda.onlyUnit": "THIS UNIT ONLY",
      "ayuda.onlyUnitDesc": "Specific link",
      "ayuda.readOnly": "READ ONLY",
      "ayuda.readOnlyDesc": "Cannot edit",
      "ayuda.photos": "PHOTOS",
      "ayuda.photosDesc": "Use the arrows",
      "ayuda.support": "SUPPORT",
      "ayuda.supportDesc": "UPA USB",
      "ayuda.gallery": "Help gallery",
      "ayuda.prev": "Previous",
      "ayuda.next": "Next",
      "ayuda.missing": "Help not found for this link.",
      "ayuda.incomplete": "Incomplete help link. Ask support for the specific unit link."
    }
  };
